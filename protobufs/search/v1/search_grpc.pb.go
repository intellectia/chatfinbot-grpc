...
const (
	...
	SearchService_GetRecQa_FullMethodName              = "/chatfinbot.search.v1.SearchService/GetRecQa"
)
...
type SearchServiceClient interface {
	...
	// 获得推荐问题和答案
	GetRecQa(ctx context.Context, in *GetRecQaReq, opts ...grpc.CallOption) (*GetRecQaRsp, error)
}
...
func (c *searchServiceClient) GetRecQa(ctx context.Context, in *GetRecQaReq, opts ...grpc.CallOption) (*GetRecQaRsp, error) {
	out := new(GetRecQaRsp)
	err := c.cc.Invoke(ctx, SearchService_GetRecQa_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SearchServiceServer interface {
	...
	// 获得推荐问题和答案
	GetRecQa(context.Context, *GetRecQaReq) (*GetRecQaRsp, error)
...
func (UnimplementedSearchServiceServer) GetRecQa(context.Context, *GetRecQaReq) (*GetRecQaRsp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRecQa not implemented")
}
...
func _SearchService_GetRecQa_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRecQaReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SearchServiceServer).GetRecQa(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SearchService_GetRecQa_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SearchServiceServer).GetRecQa(ctx, req.(*GetRecQaReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SearchService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetRecQa",
			Handler:    _SearchService_GetRecQa_Handler,
		},
	},
