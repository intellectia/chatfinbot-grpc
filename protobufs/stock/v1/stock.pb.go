...
type IndicatorsReq struct {
	...
	Code      string      `protobuf:"bytes,1,opt,name=code,proto3" json:"code,omitempty"`                                               // 股票代码
	Timespan  TimespanOpt `protobuf:"varint,2,opt,name=timespan,proto3,enum=chatfinbot.stock.v1.TimespanOpt" json:"timespan,omitempty"` // 时间的单位
	Timestamp int64       `protobuf:"varint,3,opt,name=timestamp,proto3" json:"timestamp,omitempty"`                                    // 时间戳，不传则截止到当前为止，传就截止到传的时间为止
	Count     int32       `protobuf:"varint,4,opt,name=count,proto3" json:"count,omitempty"`                                            // 数量，最大传5000，建议传800
}
...
var file_stock_proto_rawDesc = []byte{
	...
	0x28, 0x08, 0x52, 0x03, 0x4f, 0x54, 0x43, 0x22, 0x95, 0x01, 0x0a, 0x0d, 0x49, 0x6e, 0x64, 0x69,
	0x63, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x52, 0x65, 0x71, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x6f, 0x64,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x3c, 0x0a,
	0x08, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32,
	0x20, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x66, 0x69, 0x6e, 0x62, 0x6f, 0x74, 0x2e, 0x73, 0x74, 0x6f,
	0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x6e, 0x4f, 0x70,
	0x74, 0x52, 0x08, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x6e, 0x12, 0x1c, 0x0a, 0x09, 0x74,
	...
	0x6c, 0x0a, 0x0d, 0x49, 0x6e, 0x64, 0x69, 0x63, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x52, 0x73, 0x70,
	...
	0x73, 0x74, 0x6f, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x49, 0x6e, 0x64, 0x69, 0x63, 0x61, 0x74,
	0x6f, 0x72, 0x73, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x65, 0x0a,
	0x0e, 0x49, 0x6e, 0x64, 0x69, 0x63, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x44, 0x61, 0x74, 0x61, 0x12,
	...
	0x2e, 0x76, 0x31, 0x2e, 0x49, 0x6e, 0x64, 0x69, 0x63, 0x61, 0x74, 0x6f, 0x72, 0x49, 0x6e, 0x66,
	0x6f, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x6c, 0x61, 0x73, 0x74, 0x5f,
	0x74, 0x69, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x6c, 0x61, 0x73, 0x74,
	0x54, 0x69, 0x6d, 0x65, 0x22, 0x43, 0x0a, 0x0d, 0x49, 0x6e, 0x64, 0x69, 0x63, 0x61, 0x74, 0x6f,
	...
	0x28, 0x01, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x2a, 0xd4, 0x01, 0x0a, 0x0b, 0x54, 0x69,
	...
	0x32, 0xe2, 0x01, 0x0a, 0x0c, 0x53, 0x74, 0x6f, 0x63, 0x6b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x61, 0x74, 0x6f, 0x72, 0x73, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x3b, 0x73, 0x74, 0x6f, 0x63, 0x6b,
...
var file_stock_proto_goTypes = []interface{}{
	...
	(*IndicatorsReq)(nil),  // 5: chatfinbot.stock.v1.IndicatorsReq
	(*IndicatorsRsp)(nil),  // 6: chatfinbot.stock.v1.IndicatorsRsp
	(*IndicatorsData)(nil), // 7: chatfinbot.stock.v1.IndicatorsData
	(*IndicatorInfo)(nil),  // 8: chatfinbot.stock.v1.IndicatorInfo
}
var file_stock_proto_depIdxs = []int32{
	...
	0, // 3: chatfinbot.stock.v1.IndicatorsReq.timespan:type_name -> chatfinbot.stock.v1.TimespanOpt
	7, // 4: chatfinbot.stock.v1.IndicatorsRsp.data:type_name -> chatfinbot.stock.v1.IndicatorsData
	8, // 5: chatfinbot.stock.v1.IndicatorsData.list:type_name -> chatfinbot.stock.v1.IndicatorInfo
	1, // 6: chatfinbot.stock.v1.StockService.Query:input_type -> chatfinbot.stock.v1.QueryReq
	5, // 7: chatfinbot.stock.v1.StockService.Indicators:input_type -> chatfinbot.stock.v1.IndicatorsReq
	2, // 8: chatfinbot.stock.v1.StockService.Query:output_type -> chatfinbot.stock.v1.QueryRsp
	6, // 9: chatfinbot.stock.v1.StockService.Indicators:output_type -> chatfinbot.stock.v1.IndicatorsRsp
