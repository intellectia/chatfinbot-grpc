...
func (x *ShareChatReq) GetMid() int64 {
	if x != nil {
		return x.Mid
	}
	return 0
...
func (x *ShareDocReq) GetMid() int64 {
	if x != nil {
		return x.Mid
	}
	return 0
...
var file_share_proto_rawDesc = []byte{
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x22, 0x32, 0x0a, 0x0c, 0x53,
	...
	0x03, 0x6d, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x6d, 0x69, 0x64, 0x22,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x69, 0x73, 0x53, 0x68, 0x61, 0x72, 0x65, 0x32,
	0xbe, 0x09, 0x0a, 0x0c, 0x53, 0x68, 0x61, 0x72, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x6f, 0x2d, 0x69, 0x6e, 0x66, 0x6f, 0x12, 0x78, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x56, 0x69, 0x64,
...
var file_share_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
...
var file_share_proto_depIdxs = []int32{
	...
	9,  // 13: chatfinbot.share.v1.ShareService.GetVideoInfo:input_type -> chatfinbot.share.v1.GetVideoInfoReq
	12, // 14: chatfinbot.share.v1.ShareService.ShareChat:output_type -> chatfinbot.share.v1.ShareChatRsp
	20, // 15: chatfinbot.share.v1.ShareService.CheckShareChat:output_type -> chatfinbot.share.v1.CheckShareChatRsp
	14, // 16: chatfinbot.share.v1.ShareService.UnshareChat:output_type -> chatfinbot.share.v1.UnshareChatRsp
	1,  // 17: chatfinbot.share.v1.ShareService.GetChatInfo:output_type -> chatfinbot.share.v1.GetChatInfoRsp
	16, // 18: chatfinbot.share.v1.ShareService.ShareDoc:output_type -> chatfinbot.share.v1.ShareDocRsp
	18, // 19: chatfinbot.share.v1.ShareService.UnshareDoc:output_type -> chatfinbot.share.v1.UnshareDocRsp
	6,  // 20: chatfinbot.share.v1.ShareService.GetDocInfo:output_type -> chatfinbot.share.v1.GetDocInfoRsp
	22, // 21: chatfinbot.share.v1.ShareService.CheckShareDoc:output_type -> chatfinbot.share.v1.CheckShareDocRsp
	8,  // 22: chatfinbot.share.v1.ShareService.GetAudioInfo:output_type -> chatfinbot.share.v1.GetAudioInfoRsp
	10, // 23: chatfinbot.share.v1.ShareService.GetVideoInfo:output_type -> chatfinbot.share.v1.GetVideoInfoRsp
