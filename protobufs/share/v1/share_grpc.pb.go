...
const (
	...
	ShareService_GetStock_FullMethodName              = "/chatfinbot.share.v1.ShareService/GetStock"
	ShareService_ShareVideo_FullMethodName            = "/chatfinbot.share.v1.ShareService/ShareVideo"
	ShareService_UnshareVideo_FullMethodName          = "/chatfinbot.share.v1.ShareService/UnshareVideo"
	ShareService_GetVideoChatInfo_FullMethodName      = "/chatfinbot.share.v1.ShareService/GetVideoChatInfo"
)
...
type ShareServiceClient interface {
	...
	// 获取港美股信息
	GetStock(ctx context.Context, in *GetStockReq, opts ...grpc.CallOption) (*v1.GetStockRsp, error)
...
func (c *shareServiceClient) GetStock(ctx context.Context, in *GetStockReq, opts ...grpc.CallOption) (*v1.GetStockRsp, error) {
	out := new(v1.GetStockRsp)
	err := c.cc.Invoke(ctx, ShareService_GetStock_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shareServiceClient) ShareVideo(ctx context.Context, in *ShareVideoReq, opts ...grpc.CallOption) (*ShareVideoRsp, error) {
	...
	err := c.cc.Invoke(ctx, ShareService_ShareVideo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shareServiceClient) UnshareVideo(ctx context.Context, in *UnshareVideoReq, opts ...grpc.CallOption) (*UnshareVideoRsp, error) {
	...
	err := c.cc.Invoke(ctx, ShareService_UnshareVideo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shareServiceClient) GetVideoChatInfo(ctx context.Context, in *GetVideoChatInfoReq, opts ...grpc.CallOption) (*GetVideoChatInfoRsp, error) {
	...
	err := c.cc.Invoke(ctx, ShareService_GetVideoChatInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShareServiceServer interface {
	...
	// 获取港美股信息
	GetStock(context.Context, *GetStockReq) (*v1.GetStockRsp, error)
...
func (UnimplementedShareServiceServer) GetStock(context.Context, *GetStockReq) (*v1.GetStockRsp, error) {
...
func _ShareService_GetStock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetStockReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShareServiceServer).GetStock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ShareService_GetStock_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShareServiceServer).GetStock(ctx, req.(*GetStockReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ShareService_ShareVideo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ShareService_ShareVideo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ShareService_UnshareVideo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ShareService_UnshareVideo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ShareService_GetVideoChatInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ShareService_GetVideoChatInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ShareService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetStock",
			Handler:    _ShareService_GetStock_Handler,
		},
		{
