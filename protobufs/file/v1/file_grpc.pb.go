...
const (
	...
	FileService_UploadPublicFile_FullMethodName             = "/chatfinbot.file.v1.FileService/UploadPublicFile"
	...
	FileService_UploadTinyAudioFile_FullMethodName          = "/chatfinbot.file.v1.FileService/UploadTinyAudioFile"
...
func (c *fileServiceClient) UploadPublicFile(ctx context.Context, in *UploadRequest, opts ...grpc.CallOption) (*UploadResponse, error) {
	out := new(UploadResponse)
	err := c.cc.Invoke(ctx, FileService_UploadPublicFile_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fileServiceClient) UploadTinyAudioFile(ctx context.Context, in *UploadTinyAudioFileRequest, opts ...grpc.CallOption) (*UploadTinyAudioFileResponse, error) {
	...
	err := c.cc.Invoke(ctx, FileService_UploadTinyAudioFile_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _FileService_UploadPublicFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FileService_UploadPublicFile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _FileService_UploadTinyAudioFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FileService_UploadTinyAudioFile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
