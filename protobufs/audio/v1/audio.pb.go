...
type TranscriptionReq struct {
	...
	Content   []*TransContent `protobuf:"bytes,3,rep,name=content,proto3" json:"content,omitempty"`                      // 追加内容
...
func (x *TranscriptionReq) GetContent() []*TransContent {
	if x != nil {
		return x.Content
	}
	return nil
...
func (x *TransContent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TransContent) ProtoMessage() {}

func (x *TransContent) ProtoReflect() protoreflect.Message {
	mi := &file_audio_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TransContent.ProtoReflect.Descriptor instead.
func (*TransContent) Descriptor() ([]byte, []int) {
	return file_audio_proto_rawDescGZIP(), []int{8}
}

func (x *TransContent) GetStart() float64 {
	if x != nil {
		return x.Start
	}
	return 0
...
func (x *TransContent) GetText() string {
	if x != nil {
		return x.Text
	}
	return ""
...
func (x *TransContent) GetDuration() float64 {
	if x != nil {
		return x.Duration
	}
	return 0
...
func (x *TransContent) GetRole() string {
	if x != nil {
		return x.Role
	}
	return ""
...
var file_audio_proto_rawDesc = []byte{
	...
	0x75, 0x64, 0x69, 0x6f, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x43, 0x6f, 0x6e,
	...
	0x79, 0x70, 0x65, 0x22, 0x68, 0x0a, 0x0c, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x43, 0x6f, 0x6e, 0x74,
	0x65, 0x6e, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x72, 0x74, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x01, 0x52, 0x05, 0x73, 0x74, 0x61, 0x72, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x65, 0x78,
	...
	0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x22, 0x12, 0x0a,
	0x10, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x73,
	0x70, 0x22, 0x30, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x44, 0x61, 0x74,
	0x61, 0x52, 0x65, 0x71, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x5f,
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f,
	0x6e, 0x49, 0x64, 0x22, 0x47, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x44,
	0x61, 0x74, 0x61, 0x52, 0x73, 0x70, 0x12, 0x34, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01,
	...
	0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xe9, 0x03, 0x0a,
	...
	0x64, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x73, 0x70, 0x12, 0x63, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x52,
	0x65, 0x63, 0x6f, 0x72, 0x64, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x27, 0x2e, 0x63, 0x68,
	0x61, 0x74, 0x66, 0x69, 0x6e, 0x62, 0x6f, 0x74, 0x2e, 0x61, 0x75, 0x64, 0x69, 0x6f, 0x2e, 0x76,
	...
	0x63, 0x6f, 0x72, 0x64, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x73, 0x70, 0x12, 0x5d, 0x0a,
	0x0d, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x25,
	...
	0x6f, 0x6e, 0x52, 0x65, 0x71, 0x1a, 0x25, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x66, 0x69, 0x6e, 0x62,
	0x6f, 0x74, 0x2e, 0x61, 0x75, 0x64, 0x69, 0x6f, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x72, 0x61, 0x6e,
	0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x73, 0x70, 0x12, 0x5a, 0x0a, 0x0c,
	...
	0x73, 0x44, 0x61, 0x74, 0x61, 0x52, 0x73, 0x70, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x3b, 0x61, 0x75,
...
var file_audio_proto_goTypes = []interface{}{
	...
	(*TransContent)(nil),       // 8: chatfinbot.audio.v1.TransContent
...
var file_audio_proto_depIdxs = []int32{
	...
	8,  // 2: chatfinbot.audio.v1.TranscriptionReq.content:type_name -> chatfinbot.audio.v1.TransContent
	4,  // 3: chatfinbot.audio.v1.GetTransDataRsp.data:type_name -> chatfinbot.audio.v1.MediaRecord
	0,  // 4: chatfinbot.audio.v1.AudioService.CreateRecord:input_type -> chatfinbot.audio.v1.CreateRecordReq
	2,  // 5: chatfinbot.audio.v1.AudioService.GetRecordList:input_type -> chatfinbot.audio.v1.GetRecordListReq
	5,  // 6: chatfinbot.audio.v1.AudioService.GetRecordStatus:input_type -> chatfinbot.audio.v1.GetRecordStatusReq
	7,  // 7: chatfinbot.audio.v1.AudioService.Transcription:input_type -> chatfinbot.audio.v1.TranscriptionReq
	10, // 8: chatfinbot.audio.v1.AudioService.GetTransData:input_type -> chatfinbot.audio.v1.GetTransDataReq
	1,  // 9: chatfinbot.audio.v1.AudioService.CreateRecord:output_type -> chatfinbot.audio.v1.CreateRecordRsp
	3,  // 10: chatfinbot.audio.v1.AudioService.GetRecordList:output_type -> chatfinbot.audio.v1.GetRecordListRsp
	6,  // 11: chatfinbot.audio.v1.AudioService.GetRecordStatus:output_type -> chatfinbot.audio.v1.GetRecordStatusRsp
	9,  // 12: chatfinbot.audio.v1.AudioService.Transcription:output_type -> chatfinbot.audio.v1.TranscriptionRsp
	11, // 13: chatfinbot.audio.v1.AudioService.GetTransData:output_type -> chatfinbot.audio.v1.GetTransDataRsp
