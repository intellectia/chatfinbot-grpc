...
type TranscriptionReq struct {
	...
	Content   string `protobuf:"bytes,3,opt,name=content,proto3" json:"content,omitempty"`                      // 追加内容
	Status    uint32 `protobuf:"varint,4,opt,name=status,proto3" json:"status,omitempty"`                       // 状态 1=追加 2=覆盖 3=结束录制
}
...
var file_audio_proto_rawDesc = []byte{
	...
	0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x7a, 0x0a, 0x10, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x63, 0x72,
	...
	0x73, 0x22, 0x12, 0x0a, 0x10, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69,
	0x6f, 0x6e, 0x52, 0x73, 0x70, 0x22, 0x30, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x54, 0x72, 0x61, 0x6e,
	0x73, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x71, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x65, 0x73, 0x73,
	0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x73, 0x65,
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0x47, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x54, 0x72,
	0x61, 0x6e, 0x73, 0x44, 0x61, 0x74, 0x61, 0x52, 0x73, 0x70, 0x12, 0x34, 0x0a, 0x04, 0x64, 0x61,
	0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x66,
	...
	0x32, 0xe9, 0x03, 0x0a, 0x0c, 0x41, 0x75, 0x64, 0x69, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x12, 0x5a, 0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65, 0x63, 0x6f, 0x72,
	...
	0x65, 0x61, 0x74, 0x65, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x52, 0x73, 0x70, 0x12, 0x5d, 0x0a,
	...
	0x65, 0x63, 0x6f, 0x72, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x73, 0x70, 0x12, 0x63, 0x0a, 0x0f,
	...
	0x70, 0x12, 0x5d, 0x0a, 0x0d, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69,
	...
	0x12, 0x5a, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x44, 0x61, 0x74, 0x61,
	...
	0x54, 0x72, 0x61, 0x6e, 0x73, 0x44, 0x61, 0x74, 0x61, 0x52, 0x73, 0x70, 0x42, 0x0b, 0x5a, 0x09,
	0x2e, 0x3b, 0x61, 0x75, 0x64, 0x69, 0x6f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_audio_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_audio_proto_goTypes = []interface{}{
	...
	(*GetTransDataReq)(nil),    // 9: chatfinbot.audio.v1.GetTransDataReq
	(*GetTransDataRsp)(nil),    // 10: chatfinbot.audio.v1.GetTransDataRsp
}
var file_audio_proto_depIdxs = []int32{
	...
	4,  // 2: chatfinbot.audio.v1.GetTransDataRsp.data:type_name -> chatfinbot.audio.v1.MediaRecord
	0,  // 3: chatfinbot.audio.v1.AudioService.CreateRecord:input_type -> chatfinbot.audio.v1.CreateRecordReq
	2,  // 4: chatfinbot.audio.v1.AudioService.GetRecordList:input_type -> chatfinbot.audio.v1.GetRecordListReq
	5,  // 5: chatfinbot.audio.v1.AudioService.GetRecordStatus:input_type -> chatfinbot.audio.v1.GetRecordStatusReq
	7,  // 6: chatfinbot.audio.v1.AudioService.Transcription:input_type -> chatfinbot.audio.v1.TranscriptionReq
	9,  // 7: chatfinbot.audio.v1.AudioService.GetTransData:input_type -> chatfinbot.audio.v1.GetTransDataReq
	1,  // 8: chatfinbot.audio.v1.AudioService.CreateRecord:output_type -> chatfinbot.audio.v1.CreateRecordRsp
	3,  // 9: chatfinbot.audio.v1.AudioService.GetRecordList:output_type -> chatfinbot.audio.v1.GetRecordListRsp
	6,  // 10: chatfinbot.audio.v1.AudioService.GetRecordStatus:output_type -> chatfinbot.audio.v1.GetRecordStatusRsp
	8,  // 11: chatfinbot.audio.v1.AudioService.Transcription:output_type -> chatfinbot.audio.v1.TranscriptionRsp
	10, // 12: chatfinbot.audio.v1.AudioService.GetTransData:output_type -> chatfinbot.audio.v1.GetTransDataRsp
