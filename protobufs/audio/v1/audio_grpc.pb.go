...
const (
	...
	AudioService_RegenSummary_FullMethodName    = "/chatfinbot.audio.v1.AudioService/RegenSummary"
	...
	AudioService_GetSchedule_FullMethodName     = "/chatfinbot.audio.v1.AudioService/GetSchedule"
	AudioService_GetRecord_FullMethodName       = "/chatfinbot.audio.v1.AudioService/GetRecord"
	AudioService_GetMeetingType_FullMethodName  = "/chatfinbot.audio.v1.AudioService/GetMeetingType"
)
...
type AudioServiceClient interface {
	...
	RegenSummary(ctx context.Context, in *RegenSummaryReq, opts ...grpc.CallOption) (*RegenSummaryRsp, error)
	...
	GetSchedule(ctx context.Context, in *GetScheduleReq, opts ...grpc.CallOption) (*GetScheduleRsp, error)
	GetRecord(ctx context.Context, in *GetRecordReq, opts ...grpc.CallOption) (*GetRecordRsp, error)
	GetMeetingType(ctx context.Context, in *GetMeetingTypeReq, opts ...grpc.CallOption) (*GetMeetingTypeRsp, error)
}
...
func (c *audioServiceClient) RegenSummary(ctx context.Context, in *RegenSummaryReq, opts ...grpc.CallOption) (*RegenSummaryRsp, error) {
	out := new(RegenSummaryRsp)
	err := c.cc.Invoke(ctx, AudioService_RegenSummary_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *audioServiceClient) GetSchedule(ctx context.Context, in *GetScheduleReq, opts ...grpc.CallOption) (*GetScheduleRsp, error) {
	out := new(GetScheduleRsp)
	err := c.cc.Invoke(ctx, AudioService_GetSchedule_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *audioServiceClient) GetRecord(ctx context.Context, in *GetRecordReq, opts ...grpc.CallOption) (*GetRecordRsp, error) {
	out := new(GetRecordRsp)
	err := c.cc.Invoke(ctx, AudioService_GetRecord_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *audioServiceClient) GetMeetingType(ctx context.Context, in *GetMeetingTypeReq, opts ...grpc.CallOption) (*GetMeetingTypeRsp, error) {
	out := new(GetMeetingTypeRsp)
	err := c.cc.Invoke(ctx, AudioService_GetMeetingType_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AudioServiceServer interface {
	...
	RegenSummary(context.Context, *RegenSummaryReq) (*RegenSummaryRsp, error)
	...
	GetSchedule(context.Context, *GetScheduleReq) (*GetScheduleRsp, error)
	GetRecord(context.Context, *GetRecordReq) (*GetRecordRsp, error)
	GetMeetingType(context.Context, *GetMeetingTypeReq) (*GetMeetingTypeRsp, error)
...
func (UnimplementedAudioServiceServer) RegenSummary(context.Context, *RegenSummaryReq) (*RegenSummaryRsp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegenSummary not implemented")
}
...
func (UnimplementedAudioServiceServer) GetSchedule(context.Context, *GetScheduleReq) (*GetScheduleRsp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSchedule not implemented")
}
func (UnimplementedAudioServiceServer) GetRecord(context.Context, *GetRecordReq) (*GetRecordRsp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRecord not implemented")
}
func (UnimplementedAudioServiceServer) GetMeetingType(context.Context, *GetMeetingTypeReq) (*GetMeetingTypeRsp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMeetingType not implemented")
}
...
func _AudioService_RegenSummary_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegenSummaryReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AudioServiceServer).RegenSummary(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AudioService_RegenSummary_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AudioServiceServer).RegenSummary(ctx, req.(*RegenSummaryReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AudioService_GetSchedule_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetScheduleReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AudioServiceServer).GetSchedule(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AudioService_GetSchedule_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AudioServiceServer).GetSchedule(ctx, req.(*GetScheduleReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _AudioService_GetRecord_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRecordReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AudioServiceServer).GetRecord(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AudioService_GetRecord_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AudioServiceServer).GetRecord(ctx, req.(*GetRecordReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _AudioService_GetMeetingType_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetMeetingTypeReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AudioServiceServer).GetMeetingType(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AudioService_GetMeetingType_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AudioServiceServer).GetMeetingType(ctx, req.(*GetMeetingTypeReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AudioService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RegenSummary",
			Handler:    _AudioService_RegenSummary_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _AudioService_GetSchedule_Handler,
		},
		{
			MethodName: "GetRecord",
			Handler:    _AudioService_GetRecord_Handler,
		},
		{
			MethodName: "GetMeetingType",
			Handler:    _AudioService_GetMeetingType_Handler,
		},
	},
